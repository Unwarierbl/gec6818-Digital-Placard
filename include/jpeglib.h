...
struct jpeg_memory_mgr
{
    ...
    JMETHOD(JSAMPARRAY, access_virt_sarray,
            (j_common_ptr cinfo, jvirt_sarray_ptr ptr, JDIMENSION start_row, JDIMENSION num_rows,
             boolean writable));
    JMETHOD(JBLOCKARRAY, access_virt_barray,
            (j_common_ptr cinfo, jvirt_barray_ptr ptr, JDIMENSION start_row, JDIMENSION num_rows,
             boolean writable));
...
#    define jpeg_create_decompress(cinfo) \
        jpeg_CreateDecompress(            \
            (cinfo), JPEG_LIB_VERSION, (size_t)sizeof(struct jpeg_decompress_struct))
...
EXTERN(void) jpeg_mem_dest JPP((j_compress_ptr cinfo, unsigned char** outbuffer, size_t* outsize));
EXTERN(void)
jpeg_mem_src JPP((j_decompress_ptr cinfo, const unsigned char* inbuffer, size_t insize));
...
EXTERN(void)
jpeg_add_quant_table JPP((j_compress_ptr cinfo, int which_tbl, const unsigned int* basic_table,
...
EXTERN(JHUFF_TBL*) jpeg_std_huff_table JPP((j_common_ptr cinfo, boolean isDC, int tblno));
